package com.lee.git_text1.utils;

import android.content.SharedPreferences;

import com.lee.git_text1.application.MyApplication;

/**
 * @author Lee
 * @create_time 2018/5/11 15:50
 * @description 用于切换线程  SharedPreferences存、取、清除数据
 */
public class CommonUtils {
    public static final String TAG = "Lee";//sp文件的xml名称
