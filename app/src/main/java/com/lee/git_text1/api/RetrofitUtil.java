package com.lee.git_text1.api;

import android.util.Log;

import com.lee.git_text1.utils.CommonUtils;
...
public class RetrofitUtil {
    ...
    private RetrofitUtil(String baseUrl) {
        OkHttpClient okHttpClient = new OkHttpClient.Builder().addInterceptor(new CommonParamsInterceptor()).build();
        retrofit = new Retrofit.Builder().baseUrl(baseUrl).client(okHttpClient).addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build();
    }
